var module = angular.module('ToDoListApp', ['ngResource']);

module.factory('Todo', function ($resource) {
    return $resource(':login/controller', {login: '@login'});
})
...
module.controller('Controller', function ($scope, Todo) {
    var url = function () {
    ...
    $scope.delete = function (todo) {
        ...
        Todo.delete(angular.extend(url(), todo), function () {
            update();
        });
    }
